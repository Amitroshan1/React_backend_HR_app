...
def _assessment_questions_payload():
    section_1 = [
        ...
        {"number": 4, "type": "mcq", "question": "4) What is the ratio of the total sales of branch D2 for both years to the total sales of branch D4 for both years?\nMark only one oval.", "options": ["2.3", "3.5", "4.5", "7.9"]},
        ...
        {"number": 9, "type": "mcq", "question": "9) In a math class you scored 82% and 84% in two midterm exams, and 91% on the final exam. If the final exam is weighted twice as much as a midterm exam, what was your weighted average for the exams?", "options": ["84.75%", "85.25%", "87%", "85.67%"]},
        {"number": 10, "type": "mcq", "question": "10) The mean weight of a class of 35 students is 45 kg. If the weight of the teacher be included, the mean weight increases by 500 g. Find the weight of the teacher.", "options": ["63 KG", "74 KG", "84 KG", "65 KG"]},
        {"number": 11, "type": "mcq", "question": "The average height of 30 boys was calculated to be 150 cm. It was detected later that one value of 165 cm was wrongly copied as 135 cm for the computation of the mean. Find the correct mean.", "options": ["145 cm", "151 cm", "160 cm", "165 cm"]},
        {"number": 12, "type": "mcq", "question": "Find the number of triangles in the figure.", "options": ["8", "10", "12", "14"]},
        {"number": 13, "type": "mcq", "question": "13) 0.032 / 100. Select the correct answer from the multiple choice options given below.", "options": ["3.2", "0.00032", "0.0032", "32"]},
        {"number": 14, "type": "mcq", "question": "14) The average weight of 8 person's increases by 2.5 kg when a new person comes in place of one of them weighing 65 kg. What might be the weight of the new person?", "options": ["76 kg", "76.5 kg", "85 kg", "Data inadequate", "None of these"]},
        {"number": 15, "type": "mcq", "question": "15) A grocer has a sale of Rs. 6435, Rs. 6927, Rs. 6855, Rs. 7230 and Rs. 6562 for 5 consecutive months. How much sale must he have in the sixth month so that he gets an average sale of Rs. 6500?", "options": ["4991", "5991", "6001", "6991"]},
        {"number": 16, "type": "mcq", "question": "16) The average weight of 36 men is 50 kg. It was found later that the figure of 37 kg was misread as 73 kg. What is the correct average?", "options": ["49 kg", "51 kg", "50.5 kg", "None of these"]},
        {"number": 17, "type": "mcq", "question": "17) You want to make 200 ml of a solution that contains 25% salt, but only have access to solutions that are 10% salt and 50% salt. How much of each solution must you combine to get 200 ml solution that is the required 25% salt?", "options": ["65 mL of the 50% solution and 135 mL of the 10% solution", "50 mL of the 50% solution and 150 mL of the 10% solution", "75 mL of the 50% solution and 125 mL of the 10% solution", "80 mL of the 50% solution and 120 mL of the 10% solution"]},
        {"number": 18, "type": "mcq", "question": "18) The average of four numbers is 20 . If one of the numbers is removed , the average of the remaining numbers is 15. What number was removed?", "options": ["10", "15", "30", "35", "45"]},
        {"number": 19, "type": "mcq", "question": "19) On a ferry, there are 50 cars and 10 trucks. The cars have an average mass of 1200 kg and the trucks have an average mass of 3000 kg. What is the average mass of all 60 vehicles on the ferry?", "options": ["1200 kg", "1500 kg", "1800 kg", "2100 kg", "2400 kg"]},
        {"number": 20, "type": "mcq", "question": "20) In a garden, there are 10 rows and 12 columns of mango trees. The distance between the two trees is 2 meters and a distance of one meter is left from all sides of the boundary of the garden. The length of the garden is", "options": ["20 m", "22 m", "24 m", "26 m"]},
        {"number": 21, "type": "mcq", "question": "21) The average of seven numbers is 18. The average of first three numbers is 14 and the average of last three numbers is 19. What is the middle number?", "options": ["42", "57", "27", "None of these"]},
        ...
        {"number": 24, "type": "mcq", "question": "24) A cricketer has a mean score of 58 runs in nine innings. Find out how many runs are to be scored by him in the tenth innings to raise the mean score to 61.", "options": ["75", "85", "88", "90"]},
        {"number": 25, "type": "mcq", "question": "25) (1+2) x 3-4 /5 Select the correct answer from the multiple choice options given below. Select the correct answer from the multiple choice options given below.", "options": ["31/5", "1", "-3/5", "41/5"]},
    ]
    ...
    section_2 = [
        ...
        {"number": 36, "type": "subjective", "question": "How do you track level of completion of each task? And how do you record all pending task?"},
        ...
        {"number": 39, "type": "subjective", "question": "What was the last book you read? Describe the learnings from the book."},
        {"number": 40, "type": "subjective", "question": "Have you played any sport at a competitive level in life? Which one? If answer to above is Yes, what were your learnings in numbered form, from your sport?"},
        {"number": 41, "type": "subjective", "question": "Do you use any apps/ software / checklist tools to plan and track your list of tasks? If yes, tell us which tools. If no, how do you track your To Do List at work ?"},
        {"number": 42, "type": "subjective", "question": "Give us an example of something you have done in your job or in life that everybody told you, you should not do because it wouldn't work, but you still went ahead and did, and achieved success with it"},
        {"number": 43, "type": "subjective", "question": "Biggest achievement in life and professional life."},
        {"number": 44, "type": "subjective", "question": "What was your favorite subject in school, college, technical institutions? Why?"},
        {"number": 45, "type": "subjective", "question": "What has been the biggest disappointment of your life? Was it because of your inability or bad luck?"},
        {"number": 46, "type": "subjective", "question": "What is the highest number of hours you have worked in a day and how many days at a stretch?"},
        {"number": 47, "type": "subjective", "question": "What is the maximum number of hours you are prepared to work on a daily and weekly basis?"},
        {"number": 48, "type": "subjective", "question": "What are your major weaknesses? How do you intend to convert these weaknesses into strengths?"},
        {"number": 49, "type": "subjective", "question": "What is the most interesting thing you have learnt in the past 1 year?"},
        {"number": 50, "type": "subjective", "question": "What are the characteristics exhibited by the best boss you have ever had?"},
        {"number": 51, "type": "subjective", "question": "If 'present you' were competing for a job against 'old you'--i.e. yourself, three years ago--what would you say are the strengths of the \" New You\" that \" Old You\" didn't have?"},
        ...
        {"number": 54, "type": "subjective", "question": "Highlight \"THREE AREA OF IMPROVEMENT\" you would like to work upon for your growth."},
        {"number": 55, "type": "subjective", "question": "Could you tell us about a time when you got tough, brutal feedback from your boss?"},
        ...
        {"number": 58, "type": "subjective", "question": "Tell about a goal you recently achieved. What did your initial plan look like? What worked particularly well."},
        {"number": 59, "type": "subjective", "question": "Describe a time when you made a suggestion to improve something on the project that you were working on."},
        {"number": 60, "type": "subjective", "question": "Tell me about a time you had to work on several projects at once. How did you handle that?"},
        {"number": 61, "type": "subjective", "question": "Tell me about a time when you had a disagreement with another Engineer. How did you handle the situation? Were you able to reach a mutually beneficial resolution to that conflict? If not, why were you and your co-worker unable to reach a mutually beneficial resolution? If you knew then what you know now, what would you have done differently to either prevent the conflict, or to resolve it?"},
    ...
    section_3 = [
        ...
        {"number": 67, "type": "mcq", "question": "67. Which of the below options makes the most sense with respect to the following question? If your requests are met with repeated _, you should just leave him/her alone.", "options": ["hypotheses", "negatives", "rebuffs", "blunts"]},
        {"number": 68, "type": "mcq", "question": "68. Peter is a good friend _ lives in Italy, a country _ I have never visited.( Choose the correct answer and complete the sentence)", "options": ["who, what", "who, which", "that, which", "and, which"]},
        {"number": 69, "type": "mcq", "question": "In each question below, there is a sentence, of which some parts have been jumbled up. Rearrange these parts which are labelled P, Q, R and S to produce the correct sequence. Choose the proper sequence. I saw that\nP : but seeing my host in this mood\nQ : I deemed it proper to take leave\nR : as I had frequently done before\nS : it had been my intention to pass the night there", "options": ["QPSR", "QRPS", "SPQR", "SRPQ"]},
        ...
        {"number": 73, "type": "mcq", "question": "73. Jane: \"Are you going to the dance on Friday? \"Mary: \"No, I'm not. I _ school dances; they're loud, hot and crowded!\"", "options": ["not enjoy", "don't enjoy", "doesn't enjoy", "am not enjoying"]},
        ...
        {"number": 77, "type": "mcq", "question": "Come ______ with me.", "options": ["Home", "Over", "Into the store"]},
        {"number": 78, "type": "mcq", "question": "I've decided to go ___ business with John Clarke. We're going to open a small tool hire shop.", "options": ["Over", "Into", "Around", "With"]},
        {"number": 79, "type": "mcq", "question": "The journey to the party involved getting ____ a plane, _____ a car, _____ a bicycle and at last I arrived _____ the party.", "options": ["on,at,in,on", "at,in,on,at", "on,in,on,at", "at,in,on,in"]},
