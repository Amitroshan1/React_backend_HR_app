...
def _assessment_questions_payload():
    ...
    section_3 = [
        ...
        {"number": 69, "type": "mcq", "question": "In each question below, there is a sentence, of which some parts have been jumbled up. Rearrange these parts which are labelled P, Q, R and S to produce the correct sequence. Choose the proper sequence.\n\nI saw that\n\nP : but seeing my host in this mood\nQ : I deemed it proper to take leave\nR : as I had frequently done before\nS : it had been my intention to pass the night there", "options": ["QPSR", "QRPS", "SPQR", "SRPQ"]},
